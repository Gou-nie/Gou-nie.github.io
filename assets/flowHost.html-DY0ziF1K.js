import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,d as a,o as l}from"./app-Bnr7a1fZ.js";const e={};function t(p,s){return l(),n("div",null,s[0]||(s[0]=[a(`<h1 id="flowhost" tabindex="-1"><a class="header-anchor" href="#flowhost"><span>FlowHost</span></a></h1><ul><li><ol><li><a href="#first">架构流程</a></li></ol><ul><li>1.1. <a href="#firstPOne">架构流程图</a></li><li>1.2. <a href="#firstPTwo">架构说明</a></li></ul></li><li><ol start="2"><li><a href="#second">功能</a></li></ol><ul><li>2.1. <a href="#secondPOne">物理串口通讯</a></li><li>2.2. <a href="#secondPTwo">工作流编辑</a></li></ul></li></ul><p><em>一定能成!</em></p><h2 id="_1-架构流程" tabindex="-1"><a class="header-anchor" href="#_1-架构流程"><span>1. <a name="first"></a> 架构流程</span></a></h2><h3 id="_1-1-架构流程图" tabindex="-1"><a class="header-anchor" href="#_1-1-架构流程图"><span>1.1. <a name="firstPOne"></a> 架构流程图</span></a></h3><div class="language-mermaid line-numbers-mode" data-highlighter="shiki" data-ext="mermaid" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">sequenceDiagram</span></span>
